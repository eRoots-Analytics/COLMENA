...
\textcolor{red}{Further expand the paragraph above giving more information and some example on how we use these contexts.}

\textcolor{red}{Copy and paste some code showing the decorators being used.}
