...
\begin{figure}[H]
    ...
    \begin{minipage}{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim=0 0 0cm 1.6cm, clip]{figures/frequency/mpc_load.png}
    ...
    \begin{minipage}{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim=0 0 5cm 1.5cm, clip]{figures/frequency/non_mpc_load.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim=0 0 5.6cm 0.9cm, clip]{figures/frequency/mpc_generator.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim=0 0 5.6cm 0.6cm, clip]{figures/frequency/non_mpc_line.png}
