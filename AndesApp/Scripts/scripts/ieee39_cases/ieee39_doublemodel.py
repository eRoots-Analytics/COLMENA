...
system.REGF1.u.v[:] = np.zeros(n_redual)
system.REGF1.u.v[0] = 0
system.REGCP1.u.v[0] = 0
...
system.TDS_stepwise.run_set_points(set_points_dict=set_point_dict, t_change = 0, t_max =  10)    
